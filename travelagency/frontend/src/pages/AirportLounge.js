    ...
    <div className="min-h-screen bg-gray-100 py-12 px-4">
      ...
      <div className="flex justify-center mb-10">
        <div className="bg-white rounded-lg shadow-md inline-flex overflow-hidden">
          <button className="px-6 py-3 font-semibold bg-pink-600 text-white hover:bg-pink-700">SECURITY FAST TRACK</button>
          <button className="px-6 py-3 font-semibold bg-pink-600 text-white hover:bg-pink-700">PASSPORT FAST TRACK</button>
          <button className="px-6 py-3 font-semibold bg-white text-pink-700 border-r border-gray-300">AIRPORT LOUNGE</button>
        </div>
      </div>
