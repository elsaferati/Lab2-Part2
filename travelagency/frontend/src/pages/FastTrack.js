...
const FastTrack = () => {
  ...
  <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
    <div className="bg-white p-6 rounded-xl shadow text-center">
      ...
      <p>Our Fast Track passes give you access to a dedicated lane straight to the security checkpoint.</p>
    </div>
    <div className="bg-white p-6 rounded-xl shadow text-center">
      <div className="text-3xl mb-2">🕒</div>
      <p>You can book Security Fast Track up to 1 hour prior to departure.</p>
    </div>
    <div className="bg-white p-6 rounded-xl shadow text-center">
      <div className="text-3xl mb-2">✅</div>
      <p>Cut queues not corners and reach the departure lounge quicker.</p>
    </div>
  </div>
</div>
